      ...
      <Offcanvas.Body>
        <div className='d-flex flex-wrap'>
          ...
          paymentCards.map((singleCard, index) => (
           <div key={index}> <PaymentCard cardDetails={singleCard} />
           {selectedPaymentMethod === index
             ? <CustomButton size='sm' disabled= {true} value='selected' className='btn btn-outline-primary' ></CustomButton>
             : <CustomButton onClick ={ () => dispatch(UpdatePaymentMethod(index))} size='sm' value='select this' className='btn btn-outline-primary' ></CustomButton>
